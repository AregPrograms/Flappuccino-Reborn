...
class ModMenu:
    ...
    def update(self, font: pygame.font.Font):
        ...
        pygame.draw.rect(self.frame, (171, 145, 123), (0, 0, 200, 100), border_top_left_radius=10, border_top_right_radius=10)
        ...
        # Free Upgrade Code
        if self.config["freeUpgrades"]: fUp = font.render("Free Upgrades", True, green)
        elif not self.config["freeUpgrades"]: fUp = font.render("Free Upgrades", True, red)
        else: self.config["freeUpgrades"] = False # just in case
